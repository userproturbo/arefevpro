...
export default function Hero() {
  return (
    <section className="relative flex min-h-screen items-center px-6 pb-20 pt-24">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-10">
        ...
        >
          ...
          <p className="max-w-2xl text-lg text-white/70 sm:text-xl">
            A quiet space for projects, photography, video, music, and stories. Stay awhile—new work
            is shaping up behind the scenes.
          </p>
        </motion.div>
