...
export default function CharacterWindow({ children }: CharacterWindowProps) {
  return (
    <div className="relative h-[280px] w-full overflow-visible rounded-2xl border-[3px] border-black bg-[radial-gradient(circle_at_50%_20%,rgba(170,40,40,0.26),rgba(12,12,12,0.96)_70%)] shadow-[0_20px_50px_rgba(0,0,0,0.5)] md:h-[460px]">
